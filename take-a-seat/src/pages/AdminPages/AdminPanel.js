    ...
    return (
        <div className="site-main-body-created-events">
            ...
            <div className='grid' style={{'marginTop': '2rem'}}>
                ...
                <span className='col-12 md:col-12 lg:col-2'>First Name</span>
                <span className='col-12 md:col-12 lg:col-2'>Last Name</span>
                <span className='col-12 md:col-12 lg:col-2'>Email</span>
            ...
            {usersList.map((user, index) => (
                <form className='grid admin-panel-user-div' onSubmit={postEditUserRoles}>
                    ...
                    <span className='col-12 md:col-12 lg:col-2'>{user.firstName}</span>
                    <span className='col-12 md:col-12 lg:col-2'>{user.lastName}</span>
                    <span className='col-12 md:col-12 lg:col-2'>{user.email}</span>
